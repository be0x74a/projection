...
We aim to respond within **5 business days** and provide a fix or
mitigation timeline within **14 days**. If the issue is urgent, please
note that in the advisory.

## Disclosure Policy

We follow coordinated disclosure. Once a fix is available and released,
the advisory will be published publicly. If you consent, we'll credit you
by name (or handle) in the release notes and the published advisory.
